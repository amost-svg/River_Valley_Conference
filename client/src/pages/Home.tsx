  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Seo
        ...
        description="Official website of the River Valley Conference featuring 10 IHSA member schools, game schedules, conference calendar, standings, athletics news, and contact information."
        type="website"
      />
      <Navigation />
      <Hero />
